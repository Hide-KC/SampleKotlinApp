...
class RecordAdapter : RecyclerView.Adapter<RecordAdapter.BindingHolder>() {
    ...
    override fun onBindViewHolder(holder: BindingHolder, position: Int) {
        ...
        holder.binding.recordModel = recordModel
        ...
        val animation = when (holder.binding.root.context.resources.configuration.orientation) {
            ...
            Configuration.ORIENTATION_LANDSCAPE -> AnimationUtils.loadAnimation(
                holder.binding.root.context,
     ...
     */
    class Callback(
        private val old: List<RecordModel>,
        private val aNew: List<RecordModel>
    ) : DiffUtil.Callback() {
